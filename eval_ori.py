...
# config model path adn data_yaml

# MODEL_WEIGHTS = "runs/detect/yolov8-ori/weights/best.pt"
# MODEL_WEIGHTS = "runs/detect/yolov9-ori/weights/best.pt"
# MODEL_WEIGHTS = "runs/detect/yolov10-ori/weights/best.pt"
# MODEL_WEIGHTS = "runs/detect/yolo11-ori/weights/best.pt"
MODEL_WEIGHTS = "runs/detect/yolo12-ori/weights/best.pt"
# MODEL_WEIGHTS = "runs/detect/yolo-master-ori/weights/best.pt"
